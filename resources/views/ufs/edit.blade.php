...
@section('content')
    <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Editar UF #{{ $uf->codigo }}</h1>
    ...
    <form action="{{ route('ufs.update', $uf) }}" method="POST"
        ...
        <div>
            ...
            <input type="text" value="{{ $uf->codigo }}" disabled
                   class="w-full border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-400 dark:text-gray-500 rounded-lg px-4 py-2">
        </div>
        ...
        <div class="border-t dark:border-gray-700 pt-4">
            <h3 class="font-bold text-gray-700 dark:text-gray-200 mb-3">Informações de Transporte</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tipo de Caminhão</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Trajeto</label>
        ...
        <div>
            ...
            <textarea name="observacao" rows="3" maxlength="500"
                      class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg px-4 py-2 focus:ring-2 focus:ring-indigo-400 focus:outline-none">{{ old('observacao', $uf->observacao) }}</textarea>
